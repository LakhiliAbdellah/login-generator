...
public class LoginService {
    /**
     * contient touts les logins existants.
     */
     ...
     *
     * @param loginsExis le logine  existant
     */
    public LoginService(final String[] loginsExis) {
        this.loginsExistants = new ArrayList<String>(Arrays.asList(loginsExis));
